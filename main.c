...
int main(void)
{
	...
	clock_gettime_by_process_cpu_time();
	clock_gettime_by_thread_cpu_time();
	clock_gettime_by_clock_real_time();
	clock_gettime_by_clock_monotonic();
	clock_gettime_by_clock_monotonic_raw();
	clock_gettime_by_gettimeofday();
	usleep_test();
	clock_nanosleep_test();
	clock_gettime_by_process_cpu_time_with_sleep();
	return 0;
}
